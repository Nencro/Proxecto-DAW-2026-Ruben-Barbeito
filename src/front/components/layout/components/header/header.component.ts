...
export class HeaderComponent implements OnInit, OnDestroy {
  ...
  ngOnDestroy(): void {
    this.actualizarScrollPagina(false);
  }
  ...
  get esAdministrador(): boolean {
    return this.servicioAuth.getUser()?.roles?.includes('ADMIN') ?? false;
  }
  ...
  alternarMenuMovil(): void {
    ...
    this.actualizarScrollPagina(this.menuMovilAbierto);
  }
  ...
  private actualizarScrollPagina(bloqueado: boolean): void {
